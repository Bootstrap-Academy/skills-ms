...
from . import bookmarks, character_areas, course, curriculum, learning, lesson_assets, rooms, skill, xp
...
for module in [skill, bookmarks, course, xp, learning, rooms, curriculum, character_areas, lesson_assets]:
